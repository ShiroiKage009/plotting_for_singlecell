...
library(ggplot2)
library(ggrepel)
metaplastic_ant = read.csv(file = "C:/Work cache/py_projs/DGE messing around/project data cache/testing integration with separation and the stem cells part 2/saved files/metaplastic_ant.csv", row.names = 1)
